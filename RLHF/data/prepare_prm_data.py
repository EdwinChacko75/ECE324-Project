...
if __name__ == "__main__":
    ...
    parser.add_argument("--input", required=True, help="Path to raw PRM Phase 2 .jsonl file")
    parser.add_argument("--output", required=True, help="Path to save cleaned output file")
